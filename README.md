...
10. Create `config.json` and put in this repo folder. Use this template:
  ...
  ```
  Edit this file with:
  * `CWD` : Current Working Directory. Get this repo [absolute file path](https://en.wikipedia.org/wiki/Path_(computing)#Absolute_and_relative_paths) folder in your computer.
...
1. Download this script using Terminal/Command Line
  ...
  ```
2. For running it automatically, use cron job on Linux or another job scheduller to run this command daily.
  ```
